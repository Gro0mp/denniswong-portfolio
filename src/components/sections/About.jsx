            ...
            <div className={`max-w-3xl mx-auto px-4`}>
                ...
                <div className={`rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all`}>
                    <p className={`text-gray-300 mb-6`}>
                        ...
                        data for a medical tool database using Excel macros. A notable project I developed is a local
                        Weather Station, a smart, connected weather station powered by an ESP32 board and various
                        sensors.
                        It collects real-time environmental data, sends it to a dashboard, and uses AI to predict future
                        weather trends based on historical data.
                        With skills in Java, C, C++, JavaScript, and MySQL, I’m eager to apply my technical expertise to
                ...
                <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 mt-8`}>
                    ...
                    <div className={`p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all`}>
                        ...
                        <ul className={`list-disc list-inside text-gray-300 space-y-2`}>
                            ...
                            <li>
                                ...
                                Data Structures & Algorithms | Internetworking | An Introduction to Software Engineering
                                |
                                Operating Systems | Computer Architecture & Organization
                            </li>
                            <li>
                                <strong> Organizations & Awards - </strong>
                                MathWorks Scholars, Dean's Academic Recognition List in the Honors College, Chancellor's Scholarship
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className={`p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all`}>
                        ...
                        <div className={`space-y-4 text-gray-300`}>
                            <div>
                                <h4><strong> Prospect Research Data Assistant at UMass Boston (Feb 2023 - Present) </strong></h4>
                                <p> Conducted data analysis on individuals and corporations to identify donors and
                                    prospects. </p>
                            </div>
                            <div>
                                <h4><strong> Biocompatibility & Toxicology Researcher (Feb 2021 - May 2021) </strong></h4>
