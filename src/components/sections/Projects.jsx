    ...
    return (
      <section id={`projects`} className={`min-h-screen flex items-center justify-center py-20`}>
          ...
          <div className={`max-w-5xl mx-auto px-4`}>
              <h2 className={`text-3xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent text-center`}> Featured Projects </h2>
              <div className={`grid grid-cols-1 md:grid-cols-2 gap-6`}>
                  ...
                  <div
                      ...
                      <p className={`text-gray-400 mb-4`}>
                          A Java-based recommendation engine that helps users discover new games based on their Steam
                          library and preferences. The engine uses fuzzy search algorithms and tag-based analysis to
